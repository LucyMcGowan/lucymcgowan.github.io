...
<br>
Sir Austin Bradford Hill, a statistician and epidemiologist referred to henceforth as SABH, created a list of guidelines for evaluating whether there is evidence of a causal relationship.[1] He determined the following aspects of associations ought to be considered when assessing causality. When thinking about this problem, an [xkcd](https://xkcd.com/) comic I have seen in *every lecture* on this topic came to mind:
...
This inspired me to attempt to explain SABH's criteria using xkcd comics (bear with me, some of these are a stretch..). 
...
* Note: SABH suggests that huge effects *can* suggest causality, however this does not mean small effects *cannot* 
...
* This is essentially [reproducible research](http://kbroman.org/steps2rr/) & replicability
...
* I appreciate SABH's caveat here, *"if specificity exists we may be able to draw conclusions without hesitation; if it is not apparent, we are not thereby necessarily left sitting irresolutely on the fence."*
...
* If a controlled experiment can take place, this can strengthen the argument for causaility 
* *Authors note*: if a controlled experiment were likely/plausible, it seems like we wouldn't be going through this trouble of assessing causality through other means. 
